...
public class FileReceiver extends BaseTransfer implements Runnable{
    ...
    public void parseHeader() throws IOException {
        ...
        Log.i(TAG, "FileReceiver receive header size------>>>" + headTotal);
        Log.i(TAG, "FileReceiver receive header------>>>" + new String(headerBytes, UTF_8));
...
//            if(mOnReceiveListener != null) mOnReceiveListener.onProgress(total, fileSize);
        ...
        Log.i(TAG, "FileReceiver body receive######>>>" + (TimeUtils.formatTime(endTime - startTime)));
        Log.i(TAG, "FileReceiver body receive######>>>" + total);
