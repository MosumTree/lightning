 ...
 * wifi模块的主要功能类包括
 * wifimanager：包含wifi扫描，建立连接，配置等
 * scanresult：描述开启扫描后的热点信息
 * wificonfiguration：描述wifi的链接信息。包括ssid，capabilities，frequency和level
 * wifiinfo：已建立连接后的wifi信息
 * 其余还有wifilock，multicastlock
 */
